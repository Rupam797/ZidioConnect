...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-all duration-500">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className={`relative max-w-7xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl lg:text-3xl text-gray-600 dark:text-gray-300 mb-12 max-w-5xl mx-auto leading-relaxed font-light">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">500+</div>
                <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">Partner Companies</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-teal-600 dark:text-teal-400 mb-2">95%</div>
                <div className="text-sm text-gray-600 dark:text-gray-400 font-medium">Success Rate</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-cyan-600 dark:text-cyan-400 mb-2">24/7</div>
      ...
      {/* Features Section */}
      <section className="py-24 px-4 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            {/* Feature Cards */}
            <div className="group relative bg-gradient-to-br from-white to-green-50 dark:from-gray-700 dark:to-green-900/20 p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-green-100 dark:border-green-800">
              ...
              <div className="relative">
                <div className="flex justify-center mb-8 text-green-600 dark:text-green-400 group-hover:scale-110 transition-transform duration-300">
                  <AcademicCap />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white text-center">Elite Student Hub</h3>
            ...
            <div className="group relative bg-gradient-to-br from-white to-emerald-50 dark:from-gray-700 dark:to-emerald-900/20 p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-emerald-100 dark:border-emerald-800">
              ...
              <div className="relative">
                <div className="flex justify-center mb-8 text-emerald-600 dark:text-emerald-400 group-hover:scale-110 transition-transform duration-300">
                  <Briefcase />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white text-center">Recruiter Excellence</h3>
                <p className="text-gray-600 dark:text-gray-300 text-center leading-relaxed">
            ...
            <div className="group relative bg-gradient-to-br from-white to-teal-50 dark:from-gray-700 dark:to-teal-900/20 p-10 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-teal-100 dark:border-teal-800">
              ...
              <div className="relative">
                <div className="flex justify-center mb-8 text-teal-600 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300">
                  <ChartBar />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white text-center">Smart Analytics</h3>
                <p className="text-gray-600 dark:text-gray-300 text-center leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Enterprise Security</h3>
            ...
            <div className="text-center group">
              <div className="flex justify-center mb-6 text-purple-600 dark:text-purple-400 group-hover:scale-110 transition-transform duration-300">
                <Rocket />
              </div>
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Career Acceleration</h3>
              <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-xl font-bold mb-3 text-gray-900 dark:text-white">Global Network</h3>
              <p className="text-gray-600 dark:text-gray-300">
      ...
      <section className="py-24 px-4 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-5xl font-bold mb-6 text-gray-900 dark:text-white">Success Stories</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300">Hear from our community of achievers</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-green-100 dark:border-green-800">
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  JD
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">John Doe</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Software Engineer @ Google</p>
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-emerald-100 dark:border-emerald-800">
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  AS
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Alice Smith</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Head of Talent @ Microsoft</p>
                  <div className="flex text-yellow-400 mt-1">
                    ★★★★★
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-teal-100 dark:border-teal-800">
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-teal-500 to-cyan-500 flex items-center justify-center text-white font-bold text-xl mr-4 shadow-lg">
                  MJ
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Maria Johnson</h4>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Data Scientist @ Tesla</p>
                  <div className="flex text-yellow-400 mt-1">
                    ★★★★★
                  </div>
                </div>
      ...
      {/* CTA Section */}
      <section className="py-24 px-4 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 dark:from-green-700 dark:via-emerald-700 dark:to-teal-700 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link 
              ...
              className="group inline-flex items-center justify-center px-12 py-4 bg-white text-green-600 rounded-2xl font-bold text-lg hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105 transform"
            >
            ...
            {!auth && (
              <Link 
                to="/login" 
                className="inline-flex items-center justify-center px-12 py-4 border-2 border-white/30 text-white rounded-2xl font-bold text-lg hover:bg-white/10 hover:border-white/50 transition-all duration-300"
              >
                Sign In
              </Link>
            )}
